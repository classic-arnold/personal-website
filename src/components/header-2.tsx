    ...
    <>
      <div className="bg-primary fixed top-0 left-0 w-full z-50">
        <div className="flex items-center justify-between">
          <div className="p-8">
            <Link href={HOME}>
              <h4 className="uppercase text-lg md:text-4xl text-white">
                Arnold Umakhihe
              </h4>
              <h6
                className={cn([
                  fira_sans.className,
                  "text-sm md:text-xl font-extralight italic text-white",
                ])}
              >
                Software Engineer
              </h6>
          ...
          <div className="hidden md:block">
            <ul className="flex gap-x-4 md:gap-x-8 p-8 justify-end">
              {navItems.map((navItem, i) => (
                <li
                  key={i}
                  className={cn([electrolize.className, "text-lg text-white"])}
                >
          ...
          <div className="md:hidden">
            <div className="flex items-center justify-end p-4 md:p-8">
              ...
              >
                <Image src={menu} alt={"menu icon"} height={30} width={30} />
              </button>
            </div>
